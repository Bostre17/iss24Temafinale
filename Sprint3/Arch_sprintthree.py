...
with Diagram('sprintthreeArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctxwis', graph_attr=nodeattr):
          ...
          guibridge=Custom('guibridge','./qakicons/symActorSmall.png')
     ...
     incinerator >> Edge( label='burnEnd', **eventedgeattr, decorate='true', fontcolor='red') >> guibridge
     scale >> Edge( label='stateScale', **eventedgeattr, decorate='true', fontcolor='red') >> guibridge
     sys >> Edge( label='stateSonar', **evattr, decorate='true', fontcolor='darkgreen') >> guibridge
     sys >> Edge( label='burnEnd', **evattr, decorate='true', fontcolor='darkgreen') >> guibridge
